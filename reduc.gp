...
'output/data/reduc_gcc'.ARG1.'.dat' every 5::1 using 12 ti "base i5-3570", \
'output/data/reduc_gcc'.ARG1.'.dat' every 5::2 using 12 ti 'unroll i5-3570', \
'output/data/reduc_gcc'.ARG1.'.dat' every 5::3 using 12 ti 'asm i5-3570', \
'output/data/reduc_gcc'.ARG1.'.dat' every 5::4 using 12 ti 'cblas i5-3570'
...
'output/data/reduc_clang'.ARG1.'.dat' every 5::1 using 12 ti "base i5-3570", \
'output/data/reduc_clang'.ARG1.'.dat' every 5::2 using 12 ti 'unroll i5-3570', \
'output/data/reduc_clang'.ARG1.'.dat' every 5::3 using 12 ti 'asm i5-3570', \
'output/data/reduc_clang'.ARG1.'.dat' every 5::4 using 12 ti 'cblas i5-3570'
...
'output/data/reduc_icx'.ARG1.'.dat' every 5::1 using 12 ti "base i5-3570", \
'output/data/reduc_icx'.ARG1.'.dat' every 5::2 using 12 ti 'unroll i5-3570', \
'output/data/reduc_icx'.ARG1.'.dat' every 5::3 using 12 ti 'asm i5-3570', \
'output/data/reduc_icx'.ARG1.'.dat' every 5::4 using 12 ti 'cblas i5-3570'
